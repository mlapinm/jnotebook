...
# lines.writeLines(lines.nameMask + 'b2.txt',lines.lines)
...
a = True
if a:
    lines.mTranslateBig(lines.lines, couples)

textCouples = lines.mObjText(couples)

lines.write(lines.nameMask + "b1.txt", textCouples)

print(textCouples[:100])