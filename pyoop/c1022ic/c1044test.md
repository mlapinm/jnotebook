...
Just 1, whatever device is physically closest
Just 3, if the devices are all connected through a hub then to the switchport
08
...
All DHCP traffic is blocked by default 
The traffic is compared to an authorized DHCP server to see if itХs allowed
None of the above 
02
