...
//диагностика
	...
	QStringList stLiRls[14],stLiPort[10];
...
//-Port
	void slCoBoPort1ModProt(int index);
	void slCoBoPort1DopId(int index);
	void slCoBoPort1Led(int index);
	void slCoBoPort2ModProt(int index);
	void slCoBoPort2DopId(int index);
	void slCoBoPort2Led(int index);
	void slCoBoPort3ModProt(int index);
	void slCoBoPort3DopId(int index);
	void slCoBoPort3Led(int index);
	void slCoBoPort4ModProt(int index);
	void slCoBoPort4DopId(int index);
	void slCoBoPort4Led(int index);
	void slCoBoPort5ModProt(int index);
	void slCoBoPort5DopId(int index);
	void slCoBoPort5Led(int index);
	void slCoBoPort6ModProt(int index);
	void slCoBoPort6DopId(int index);
	void slCoBoPort6Led(int index);
	void slCoBoPort7ModProt(int index);
	void slCoBoPort7DopId(int index);
	void slCoBoPort7Led(int index);
	void slCoBoPort8ModProt(int index);
	void slCoBoPort8DopId(int index);
	void slCoBoPort8Led(int index);
	void slCoBoPort9ModProt(int index);
	void slCoBoPort9DopId(int index);
	void slCoBoPort9Led(int index);
	void slCoBoPort10ModProt(int index);
	void slCoBoPort10DopId(int index);
	void slCoBoPort10Led(int index);
//-Rls
	void slCoBoRls1ModProt(int index);
	void slCoBoRls1DopId(int index);
	void slChBoRls1UseArp1();
	void slChBoRls1UseArp2();
	void slChBoRls1FiewGroup1();
	void slChBoRls1FiewGroup2();
	void slChBoRls1UseDopId();
	void slCoBoRls2ModProt(int index);
	void slCoBoRls2DopId(int index);
	void slChBoRls2UseArp1();
	void slChBoRls2UseArp2();
	void slChBoRls2FiewGroup1();
	void slChBoRls2FiewGroup2();
	void slChBoRls2UseDopId();
	void slCoBoRls3ModProt(int index);
	void slCoBoRls3DopId(int index);
	void slChBoRls3UseArp1();
	void slChBoRls3UseArp2();
	void slChBoRls3FiewGroup1();
	void slChBoRls3FiewGroup2();
	void slChBoRls3UseDopId();
	void slCoBoRls4ModProt(int index);
	void slCoBoRls4DopId(int index);
	void slChBoRls4UseArp1();
	void slChBoRls4UseArp2();
	void slChBoRls4FiewGroup1();
	void slChBoRls4FiewGroup2();
	void slChBoRls4UseDopId();
	void slCoBoRls5ModProt(int index);
	void slCoBoRls5DopId(int index);
	void slChBoRls5UseArp1();
	void slChBoRls5UseArp2();
	void slChBoRls5FiewGroup1();
	void slChBoRls5FiewGroup2();
	void slChBoRls5UseDopId();
	void slCoBoRls6ModProt(int index);
	void slCoBoRls6DopId(int index);
	void slChBoRls6UseArp1();
	void slChBoRls6UseArp2();
	void slChBoRls6FiewGroup1();
	void slChBoRls6FiewGroup2();
	void slChBoRls6UseDopId();
...
//Rls1::::::::::::::РЛС1
	...
	void slLiEdRls1Prdms();
	void slLiEdRls2Prdms();
	void slLiEdRls3Prdms();
	void slLiEdRls4Prdms();
	void slLiEdRls5Prdms();
	void slLiEdRls6Prdms();
	...
	void slLiEdRls1DistanceAxisVPP_2();
...
//Rls2::::::::::::::РЛС2
	...
	void slLiEdRls2DistanceAxisVPP_2();
...
//Rls3::::::::::::::РЛС3
	...
	void slLiEdRls3DistanceAxisVPP_2();
...
//Rls4::::::::::::::РЛС4
	...
	void slLiEdRls4DistanceAxisVPP_2();
...
//Rls5::::::::::::::РЛС5
	...
	void slLiEdRls5DistanceAxisVPP_2();
...
//Rls6::::::::::::::РЛС6
	...
	void slLiEdRls6DistanceAxisVPP_2();
...
//end Arp2::::::::::::::РЛС1
//-Arp
	void slCoBoArp1ModProt(int index);
	void slCoBoArp1DopId(int index);
	void slChBoArp1UseDopId();
	void slCoBoArp2ModProt(int index);
	void slCoBoArp2DopId(int index);
	void slChBoArp2UseDopId();
...
//end Sev2::::::::::::::РЛС1
//-Sev
	void slCoBoSev1DopId(int index);
	void slChBoSev1UseDopId();
	void slCoBoSev2DopId(int index);
	void slChBoSev2UseDopId();
//-Met
	void slCoBoMet1DopId(int index);
	void slChBoMet1UseDopId();
	void slCoBoMet2DopId(int index);
	void slChBoMet2UseDopId();
//-Met3
	void slCoBoMet3DopId(int index);
	void slChBoMet3UseDopId();
	void slCoBoMet4DopId(int index);
	void slChBoMet4UseDopId();
