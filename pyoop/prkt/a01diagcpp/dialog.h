...
public:
	...
	int iCurrentIndex;
	bool bCurrentIndex0;	//true - нулева¤ страница, iCurrentIndex не мен¤етс¤.
	QTabWidget* tabWidget,*tabWidget_2;
public:
	int iChoiceRls,iChoiceArp;
	QLabel* laRlsArp;
	QString sRls_x,sArp_y;
	void fChoice();
...
public:
	...
	PLineEdit* lineEditMaxLengthUnit,*lineEditMaxWaitRay,*lineEditSelectorMa10;
...
//ѕереключаемые параметры
	...
	QLineEdit* lineEditRls0DistanceAxisVPP2,*lineEditRls1DistanceAxisVPP2;
	...
	PLineEdit* lineEditRls0TurnKO,*lineEditRls1TurnKO;
	...
	OLineEdit* lineEditCompensZ,*lineEditCompensPass,*lineEditCompensAct;
	OLineEdit* lineEditCompensInput1,*lineEditCompensInput2;
	QLineEdit* lineEditRiftPass1,*lineEditRiftAct1,*lineEditRiftAct2;
...
protected:
	...
	void showWriteRpzu();
	void showRegain();
	void initTimers();		//запись –ѕ«”, восстановление
protected slots:
//Ёкранные слоты:
	void slTabCurIndChange(int i);
...
//arguments(параметры)
	...
	void fLineEditRls0DistanceAxisVPP2();
...
//rls1
	...
	void fLineEditRls1DistanceAxisVPP2();
	void fLineEditRls1PointPlanting2();

	void slLiEdRls0TurnCorr();
	void slLiEdRls1TurnCorr();
...
//	void retrySlot();	//повтор¤т вызов экранного слота
