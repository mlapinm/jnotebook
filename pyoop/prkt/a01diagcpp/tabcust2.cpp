...
//	connect(ui.raBuPort10Sincr,SIGNAL(clicked()),this,SLOT(slRaBuPort10Asincr()));
	...
	connect(ui.coBoPort1ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort1ModProt(int)));
	connect(ui.coBoPort1DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort1DopId(int)));
	connect(ui.coBoPort1Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort1Led(int)));
	connect(ui.coBoPort2ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort2ModProt(int)));
	connect(ui.coBoPort2DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort2DopId(int)));
	connect(ui.coBoPort2Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort2Led(int)));
	connect(ui.coBoPort3ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort3ModProt(int)));
	connect(ui.coBoPort3DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort3DopId(int)));
	connect(ui.coBoPort3Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort3Led(int)));
	connect(ui.coBoPort4ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort4ModProt(int)));
	connect(ui.coBoPort4DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort4DopId(int)));
	connect(ui.coBoPort4Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort4Led(int)));
	connect(ui.coBoPort5ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort5ModProt(int)));
	connect(ui.coBoPort5DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort5DopId(int)));
	connect(ui.coBoPort5Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort5Led(int)));
	connect(ui.coBoPort6ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort6ModProt(int)));
	connect(ui.coBoPort6DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort6DopId(int)));
	connect(ui.coBoPort6Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort6Led(int)));
	connect(ui.coBoPort7ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort7ModProt(int)));
	connect(ui.coBoPort7DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort7DopId(int)));
	connect(ui.coBoPort7Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort7Led(int)));
	connect(ui.coBoPort8ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort8ModProt(int)));
	connect(ui.coBoPort8DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort8DopId(int)));
	connect(ui.coBoPort8Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort8Led(int)));
	connect(ui.coBoPort9ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort9ModProt(int)));
	connect(ui.coBoPort9DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort9DopId(int)));
	connect(ui.coBoPort9Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort9Led(int)));
	connect(ui.coBoPort10ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort10ModProt(int)));
	connect(ui.coBoPort10DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort10DopId(int)));
	connect(ui.coBoPort10Led,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoPort10Led(int)));
//-Rls
	connect(ui.coBoRls1ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls1ModProt(int)));
	connect(ui.coBoRls1DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls1DopId(int)));
	connect(ui.chBoRls1UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls1UseArp1()));
	connect(ui.chBoRls1UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls1UseArp2()));
	connect(ui.chBoRls1FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls1FiewGroup1()));
	connect(ui.chBoRls1FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls1FiewGroup2()));
	connect(ui.chBoRls1UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls1UseDopId()));
	connect(ui.coBoRls2ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls2ModProt(int)));
	connect(ui.coBoRls2DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls2DopId(int)));
	connect(ui.chBoRls2UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls2UseArp1()));
	connect(ui.chBoRls2UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls2UseArp2()));
	connect(ui.chBoRls2FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls2FiewGroup1()));
	connect(ui.chBoRls2FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls2FiewGroup2()));
	connect(ui.chBoRls2UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls2UseDopId()));
	connect(ui.coBoRls3ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls3ModProt(int)));
	connect(ui.coBoRls3DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls3DopId(int)));
	connect(ui.chBoRls3UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls3UseArp1()));
	connect(ui.chBoRls3UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls3UseArp2()));
	connect(ui.chBoRls3FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls3FiewGroup1()));
	connect(ui.chBoRls3FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls3FiewGroup2()));
	connect(ui.chBoRls3UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls3UseDopId()));
	connect(ui.coBoRls4ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls4ModProt(int)));
	connect(ui.coBoRls4DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls4DopId(int)));
	connect(ui.chBoRls4UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls4UseArp1()));
	connect(ui.chBoRls4UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls4UseArp2()));
	connect(ui.chBoRls4FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls4FiewGroup1()));
	connect(ui.chBoRls4FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls4FiewGroup2()));
	connect(ui.chBoRls4UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls4UseDopId()));
	connect(ui.coBoRls5ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls5ModProt(int)));
	connect(ui.coBoRls5DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls5DopId(int)));
	connect(ui.chBoRls5UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls5UseArp1()));
	connect(ui.chBoRls5UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls5UseArp2()));
	connect(ui.chBoRls5FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls5FiewGroup1()));
	connect(ui.chBoRls5FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls5FiewGroup2()));
	connect(ui.chBoRls5UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls5UseDopId()));
	connect(ui.coBoRls6ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls6ModProt(int)));
	connect(ui.coBoRls6DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoRls6DopId(int)));
	connect(ui.chBoRls6UseArp1,SIGNAL(clicked()),this,SLOT(slChBoRls6UseArp1()));
	connect(ui.chBoRls6UseArp2,SIGNAL(clicked()),this,SLOT(slChBoRls6UseArp2()));
	connect(ui.chBoRls6FiewGroup1,SIGNAL(clicked()),this,SLOT(slChBoRls6FiewGroup1()));
	connect(ui.chBoRls6FiewGroup2,SIGNAL(clicked()),this,SLOT(slChBoRls6FiewGroup2()));
	connect(ui.chBoRls6UseDopId,SIGNAL(clicked()),this,SLOT(slChBoRls6UseDopId()));
...
//Rls1::::::::::::::РЛС1
	...
	connect(ui.liEdRls1Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls1Prdms()));
	connect(ui.liEdRls2Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls2Prdms()));
	connect(ui.liEdRls3Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls3Prdms()));
	connect(ui.liEdRls4Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls4Prdms()));
	connect(ui.liEdRls5Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls5Prdms()));
	connect(ui.liEdRls6Prdms,SIGNAL(editingFinished()),this,SLOT(slLiEdRls6Prdms()));
	...
	connect(ui.liEdRls1DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls1DistanceAxisVPP_2()));
...
//Rls2::::::::::::::РЛС2
	...
	connect(ui.liEdRls2DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls2DistanceAxisVPP_2()));
...
//Rls3::::::::::::::РЛС3
	...
	connect(ui.liEdRls3DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls3DistanceAxisVPP_2()));
...
//Rls4::::::::::::::РЛС4
	...
	connect(ui.liEdRls4DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls4DistanceAxisVPP_2()));
...
//Rls5::::::::::::::РЛС5
	...
	connect(ui.liEdRls5DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls5DistanceAxisVPP_2()));
...
//Rls6::::::::::::::РЛС6
	...
	connect(ui.liEdRls6DistanceAxisVPP_2,SIGNAL(editingFinished()),this,SLOT(slLiEdRls6DistanceAxisVPP_2()));
...
{
	if(ui.coBoPort1Boude->hasFocus()&&index<16)
	{
		int iAddr =44;
		short a1=0;
...
{
	if(ui.coBoPort1AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =45;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort1SincrProt->hasFocus()||ui.coBoPort1SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =45;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort2Boude->hasFocus()&&index<16)
	{
		int iAddr =46;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort2AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =47;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort2SincrProt->hasFocus()||ui.coBoPort2SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =47;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort3Boude->hasFocus()&&index<16)
	{
		int iAddr =48;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort3AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =49;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort3SincrProt->hasFocus()||ui.coBoPort3SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =49;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort4Boude->hasFocus()&&index<16)
	{
		int iAddr =50;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort4AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =51;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort4SincrProt->hasFocus()||ui.coBoPort4SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =51;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort5Boude->hasFocus()&&index<16)
	{
		int iAddr =52;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort5AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =53;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort5SincrProt->hasFocus()||ui.coBoPort5SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =53;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort6Boude->hasFocus()&&index<16)
	{
		int iAddr =54;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort6AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =55;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort6SincrProt->hasFocus()||ui.coBoPort6SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =55;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort7Boude->hasFocus()&&index<16)
	{
		int iAddr =56;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort7AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =57;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort7SincrProt->hasFocus()||ui.coBoPort7SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =57;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort8Boude->hasFocus()&&index<16)
	{
		int iAddr =58;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort8AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =59;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort8SincrProt->hasFocus()||ui.coBoPort8SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =59;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort9Boude->hasFocus()&&index<16)
	{
		int iAddr =60;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort9AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =61;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if((ui.coBoPort9SincrProt->hasFocus()||ui.coBoPort9SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =61;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
{
	if(ui.coBoPort10Boude->hasFocus()&&index<16)
	{
		int iAddr =62;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index+3);
...
{
	if(ui.coBoPort10AsincrProt->hasFocus()&&index<15)
	{
		int iAddr =63;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort10SincrProt(int index)
{
	index = 0;
/*
	if((ui.coBoPort10SincrProt->hasFocus()||ui.coBoPort10SincrProt_2->hasFocus())&&index<16)
	{
		int iAddr =63;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port
void TabCust::slCoBoPort1ModProt(int index)
{
	if(ui.coBoPort1ModProt->hasFocus()&&index<8)
	{
		int iAddr =45;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
		wrd.s.bit10=wrdWr.s.bit0;
		wrd.s.bit11=wrdWr.s.bit1;
		unitReceive->basicSetting[iAddr]=wrd.f();
		unitSend->basicSetting[iAddr]=wrd.f();
	}
	return;
}
void TabCust::slCoBoPort1DopId(int index)
{
	if(ui.coBoPort1DopId->hasFocus()&&index<4)
	{
		int iAddr =45;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
		wrd.s.bit12=wrdWr.s.bit0;
		wrd.s.bit13=wrdWr.s.bit1;
		unitReceive->basicSetting[iAddr]=wrd.f();
		unitSend->basicSetting[iAddr]=wrd.f();
	}
	return;
}
void TabCust::slCoBoPort1Led(int index)
{
	if(ui.coBoPort1Led->hasFocus()&&index<16)
	{
		int iAddr =44;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port2
void TabCust::slCoBoPort2ModProt(int index)
{
	if(ui.coBoPort2ModProt->hasFocus()&&index<8)
	{
		int iAddr =47;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort2DopId(int index)
{
	if(ui.coBoPort2DopId->hasFocus()&&index<4)
	{
		int iAddr =47;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort2Led(int index)
{
	if(ui.coBoPort2Led->hasFocus()&&index<16)
	{
		int iAddr =46;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port3
void TabCust::slCoBoPort3ModProt(int index)
{
	if(ui.coBoPort3ModProt->hasFocus()&&index<8)
	{
		int iAddr =49;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort3DopId(int index)
{
	if(ui.coBoPort3DopId->hasFocus()&&index<4)
	{
		int iAddr =49;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort3Led(int index)
{
	if(ui.coBoPort3Led->hasFocus()&&index<16)
	{
		int iAddr =48;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port4
void TabCust::slCoBoPort4ModProt(int index)
{
	if(ui.coBoPort4ModProt->hasFocus()&&index<8)
	{
		int iAddr =51;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort4DopId(int index)
{
	if(ui.coBoPort4DopId->hasFocus()&&index<4)
	{
		int iAddr =51;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort4Led(int index)
{
	if(ui.coBoPort4Led->hasFocus()&&index<16)
	{
		int iAddr =50;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port5
void TabCust::slCoBoPort5ModProt(int index)
{
	if(ui.coBoPort5ModProt->hasFocus()&&index<8)
	{
		int iAddr =53;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort5DopId(int index)
{
	if(ui.coBoPort5DopId->hasFocus()&&index<4)
	{
		int iAddr =53;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort5Led(int index)
{
	if(ui.coBoPort5Led->hasFocus()&&index<16)
	{
		int iAddr =52;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port6
void TabCust::slCoBoPort6ModProt(int index)
{
	if(ui.coBoPort6ModProt->hasFocus()&&index<8)
	{
		int iAddr =55;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort6DopId(int index)
{
	if(ui.coBoPort6DopId->hasFocus()&&index<4)
	{
		int iAddr =55;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort6Led(int index)
{
	if(ui.coBoPort6Led->hasFocus()&&index<16)
	{
		int iAddr =54;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port7
void TabCust::slCoBoPort7ModProt(int index)
{
	if(ui.coBoPort7ModProt->hasFocus()&&index<8)
	{
		int iAddr =57;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort7DopId(int index)
{
	if(ui.coBoPort7DopId->hasFocus()&&index<4)
	{
		int iAddr =57;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort7Led(int index)
{
	if(ui.coBoPort7Led->hasFocus()&&index<16)
	{
		int iAddr =56;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port8
void TabCust::slCoBoPort8ModProt(int index)
{
	if(ui.coBoPort8ModProt->hasFocus()&&index<8)
	{
		int iAddr =59;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort8DopId(int index)
{
	if(ui.coBoPort8DopId->hasFocus()&&index<4)
	{
		int iAddr =59;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort8Led(int index)
{
	if(ui.coBoPort8Led->hasFocus()&&index<16)
	{
		int iAddr =58;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port9
void TabCust::slCoBoPort9ModProt(int index)
{
	if(ui.coBoPort9ModProt->hasFocus()&&index<8)
	{
		int iAddr =61;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort9DopId(int index)
{
	if(ui.coBoPort9DopId->hasFocus()&&index<4)
	{
		int iAddr =61;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort9Led(int index)
{
	if(ui.coBoPort9Led->hasFocus()&&index<16)
	{
		int iAddr =60;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Port10
void TabCust::slCoBoPort10ModProt(int index)
{
	if(ui.coBoPort10ModProt->hasFocus()&&index<8)
	{
		int iAddr =63;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort10DopId(int index)
{
	if(ui.coBoPort10DopId->hasFocus()&&index<4)
	{
		int iAddr =63;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoPort10Led(int index)
{
	if(ui.coBoPort10Led->hasFocus()&&index<16)
	{
		int iAddr =62;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
//-Rls1
void TabCust::slCoBoRls1ModProt(int index)
{
	if(ui.coBoRls1ModProt->hasFocus()&&index<16)
	{
		int iAddr =64;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
		wrd.s.bit12=wrdWr.s.bit0;
		wrd.s.bit13=wrdWr.s.bit1;
		wrd.s.bit14=wrdWr.s.bit2;
		unitReceive->basicSetting[iAddr]=wrd.f();
		unitSend->basicSetting[iAddr]=wrd.f();
	}
	return;
}
void TabCust::slCoBoRls1DopId(int index)
{
	if(ui.coBoRls1DopId->hasFocus()&&index<16)
	{
		int iAddr =67;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls1UseArp1()
{
	int iAddr =67;
	bool b;
	b=ui.chBoRls1UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls1UseArp2()
{
	int iAddr =67;
	bool b;
	b=ui.chBoRls1UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls1FiewGroup1()
{
	int iAddr =67;
	bool b;
	b=ui.chBoRls1FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls1FiewGroup2()
{
	int iAddr =67;
	bool b;
	b=ui.chBoRls1FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls1UseDopId()
{
	int iAddr =67;
	bool b;
	b=ui.chBoRls1UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Rls2
void TabCust::slCoBoRls2ModProt(int index)
{
	if(ui.coBoRls2ModProt->hasFocus()&&index<16)
	{
		int iAddr =92;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoRls2DopId(int index)
{
	if(ui.coBoRls2DopId->hasFocus()&&index<16)
	{
		int iAddr =95;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls2UseArp1()
{
	int iAddr =95;
	bool b;
	b=ui.chBoRls2UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls2UseArp2()
{
	int iAddr =95;
	bool b;
	b=ui.chBoRls2UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls2FiewGroup1()
{
	int iAddr =95;
	bool b;
	b=ui.chBoRls2FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls2FiewGroup2()
{
	int iAddr =95;
	bool b;
	b=ui.chBoRls2FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls2UseDopId()
{
	int iAddr =95;
	bool b;
	b=ui.chBoRls2UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Rls3
void TabCust::slCoBoRls3ModProt(int index)
{
	if(ui.coBoRls3ModProt->hasFocus()&&index<16)
	{
		int iAddr =120;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoRls3DopId(int index)
{
	if(ui.coBoRls3DopId->hasFocus()&&index<16)
	{
		int iAddr =123;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls3UseArp1()
{
	int iAddr =123;
	bool b;
	b=ui.chBoRls3UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls3UseArp2()
{
	int iAddr =123;
	bool b;
	b=ui.chBoRls3UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls3FiewGroup1()
{
	int iAddr =123;
	bool b;
	b=ui.chBoRls3FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls3FiewGroup2()
{
	int iAddr =123;
	bool b;
	b=ui.chBoRls3FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls3UseDopId()
{
	int iAddr =123;
	bool b;
	b=ui.chBoRls3UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Rls4
void TabCust::slCoBoRls4ModProt(int index)
{
	if(ui.coBoRls4ModProt->hasFocus()&&index<16)
	{
		int iAddr =148;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoRls4DopId(int index)
{
	if(ui.coBoRls4DopId->hasFocus()&&index<16)
	{
		int iAddr =151;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls4UseArp1()
{
	int iAddr =151;
	bool b;
	b=ui.chBoRls4UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls4UseArp2()
{
	int iAddr =151;
	bool b;
	b=ui.chBoRls4UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls4FiewGroup1()
{
	int iAddr =151;
	bool b;
	b=ui.chBoRls4FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls4FiewGroup2()
{
	int iAddr =151;
	bool b;
	b=ui.chBoRls4FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls4UseDopId()
{
	int iAddr =151;
	bool b;
	b=ui.chBoRls4UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Rls5
void TabCust::slCoBoRls5ModProt(int index)
{
	if(ui.coBoRls5ModProt->hasFocus()&&index<16)
	{
		int iAddr =176;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoRls5DopId(int index)
{
	if(ui.coBoRls5DopId->hasFocus()&&index<16)
	{
		int iAddr =179;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls5UseArp1()
{
	int iAddr =179;
	bool b;
	b=ui.chBoRls5UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls5UseArp2()
{
	int iAddr =179;
	bool b;
	b=ui.chBoRls5UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls5FiewGroup1()
{
	int iAddr =179;
	bool b;
	b=ui.chBoRls5FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls5FiewGroup2()
{
	int iAddr =179;
	bool b;
	b=ui.chBoRls5FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls5UseDopId()
{
	int iAddr =179;
	bool b;
	b=ui.chBoRls5UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Rls6
void TabCust::slCoBoRls6ModProt(int index)
{
	if(ui.coBoRls6ModProt->hasFocus()&&index<16)
	{
		int iAddr =204;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoRls6DopId(int index)
{
	if(ui.coBoRls6DopId->hasFocus()&&index<16)
	{
		int iAddr =207;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoRls6UseArp1()
{
	int iAddr =207;
	bool b;
	b=ui.chBoRls6UseArp1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit10=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls6UseArp2()
{
	int iAddr =207;
	bool b;
	b=ui.chBoRls6UseArp2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit11=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls6FiewGroup1()
{
	int iAddr =207;
	bool b;
	b=ui.chBoRls6FiewGroup1->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit12=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls6FiewGroup2()
{
	int iAddr =207;
	bool b;
	b=ui.chBoRls6FiewGroup2->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit13=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls6UseDopId()
{
	int iAddr =207;
	bool b;
	b=ui.chBoRls6UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
void TabCust::slChBoRls1UsePort()
{
	...
	wrd.f(
		unitReceive->basicSetting[iAddr])->bit8=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
	unitSend->basicSetting[iAddr]=wrd.f();
	return;
}
...
void TabCust::slChBoRls1UseSAC()
{
	...
	wrd.f(
		unitReceive->basicSetting[iAddr])->bit6=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
	unitSend->basicSetting[iAddr]=wrd.f();
	return;
}
...
void TabCust::slChBoRls1UseSIC()
{
	...
	wrd.f(
		unitReceive->basicSetting[iAddr])->bit7=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
	unitSend->basicSetting[iAddr]=wrd.f();
	return;
}
...
void TabCust::slLiEdRls1Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls1Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls1Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls2Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls2Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls2Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls3Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls3Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls3Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls4Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls4Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls4Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls5Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls5Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls5Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls6Prdms()
{
//81
	int iAddr = 81;
	iAddr=iAddrRls6Base+17;						//78;
	PLineEdit* lineEdit = ui.liEdRls6Prdms;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
{
//85 удаление антенны от продольной оси ВПП (число знаковое), м, направление 1
	int iAddr = 85;
	iAddr=iAddrRls1Base+21;						//85;
...
void TabCust::slLiEdRls1DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls1Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls1DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls2DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls2Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls2DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls3DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls3Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls3DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls4DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls4Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls4DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls5DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls5Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls5DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
void TabCust::slLiEdRls6DistanceAxisVPP_2()
{
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	int iAddr = 86;
	iAddr=iAddrRls6Base+22;						//86;
	PLineEdit* lineEdit = ui.liEdRls6DistanceAxisVPP_2;
	int b1;
	QString str1,str2;
	str1=lineEdit->text();
	b1=str1.toInt();
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort1Boude->setCurrentIndex(b1);
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort2Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort3Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort4Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort5Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort6Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort7Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort8Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort9Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//bits 3...0	-	скорость
	...
	b1 =wrd.s.bit3*8+wrd.s.bit2*4+wrd.s.bit1*2+wrd.s.bit0 - 3;
	b1 = b1<0 ? 0 : b1;
	ui.coBoPort10Boude->setCurrentIndex(b1);
//бит 4: 0 — бит четности отсутствует, 1 — бит четности присутствует
//бит 5: 0 — четность, 1 — нечетность
	if(wrd.s.bit4==0)
	{
...
//------------------//
//-Port1
//биты 27…26: модификация протокола
	iAddr0 =45;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort1ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =45;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort1DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =44;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort1Led->setCurrentIndex(a1);
//-Port2
//биты 27…26: модификация протокола
	iAddr0 =47;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort2ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =47;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort2DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =46;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort2Led->setCurrentIndex(a1);
//-Port3
//биты 27…26: модификация протокола
	iAddr0 =49;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort3ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =49;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort3DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =48;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort3Led->setCurrentIndex(a1);
//-Port4
//биты 27…26: модификация протокола
	iAddr0 =51;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort4ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =51;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort4DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =50;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort4Led->setCurrentIndex(a1);
//-Port5
//биты 27…26: модификация протокола
	iAddr0 =53;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort5ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =53;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort5DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =52;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort5Led->setCurrentIndex(a1);
//-Port6
//биты 27…26: модификация протокола
	iAddr0 =55;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort6ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =55;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort6DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =54;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort6Led->setCurrentIndex(a1);
//-Port7
//биты 27…26: модификация протокола
	iAddr0 =57;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort7ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =57;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort7DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =56;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort7Led->setCurrentIndex(a1);
//-Port8
//биты 27…26: модификация протокола
	iAddr0 =59;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort8ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =59;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort8DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =58;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort8Led->setCurrentIndex(a1);
//-Port9
//биты 27…26: модификация протокола
	iAddr0 =61;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort9ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =61;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort9DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =60;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort9Led->setCurrentIndex(a1);
//-Port10
//биты 27…26: модификация протокола
	iAddr0 =63;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit11*2+wrd.s.bit10;
	ui.coBoPort10ModProt->setCurrentIndex(a1);
//биты 29…28: дополнительный идентификатор
	iAddr0 =63;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoPort10DopId->setCurrentIndex(a1);
//биты 14…11: номер светодиода для индикации (0 — светодиод не использовать)
	iAddr0 =62;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*8+wrd.s.bit13*4+wrd.s.bit12*2+wrd.s.bit11;
	ui.coBoPort10Led->setCurrentIndex(a1);
//-Rls1
//биты 14…12 номер модификации протокола
	iAddr0 =64;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls1ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =67;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls1DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =67;
	ui.chBoRls1UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =67;
	ui.chBoRls1UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =67;
	ui.chBoRls1FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =67;
	ui.chBoRls1FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =67;
	ui.chBoRls1UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Rls2
//биты 14…12 номер модификации протокола
	iAddr0 =92;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls2ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =95;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls2DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =95;
	ui.chBoRls2UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =95;
	ui.chBoRls2UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =95;
	ui.chBoRls2FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =95;
	ui.chBoRls2FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =95;
	ui.chBoRls2UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Rls3
//биты 14…12 номер модификации протокола
	iAddr0 =120;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls3ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =123;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls3DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =123;
	ui.chBoRls3UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =123;
	ui.chBoRls3UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =123;
	ui.chBoRls3FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =123;
	ui.chBoRls3FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =123;
	ui.chBoRls3UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Rls4
//биты 14…12 номер модификации протокола
	iAddr0 =148;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls4ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =151;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls4DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =151;
	ui.chBoRls4UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =151;
	ui.chBoRls4UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =151;
	ui.chBoRls4FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =151;
	ui.chBoRls4FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =151;
	ui.chBoRls4UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Rls5
//биты 14…12 номер модификации протокола
	iAddr0 =176;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls5ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =179;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls5DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =179;
	ui.chBoRls5UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =179;
	ui.chBoRls5UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =179;
	ui.chBoRls5FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =179;
	ui.chBoRls5FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =179;
	ui.chBoRls5UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Rls6
//биты 14…12 номер модификации протокола
	iAddr0 =204;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoRls6ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =207;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoRls6DopId->setCurrentIndex(a1);
//бит 26(10) признак наличия АРП-1 (1)
	iAddr0 =207;
	ui.chBoRls6UseArp1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit10);
//бит 27(11) признак наличия АРП-2 (1)
	iAddr0 =207;
	ui.chBoRls6UseArp2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit11);
//бит 28(12) признак наличия нескольких портов приема первой группы (1)
	iAddr0 =207;
	ui.chBoRls6FiewGroup1->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit12);
//бит 29(13) признак наличия нескольких портов приема второй группы (1)
	iAddr0 =207;
	ui.chBoRls6FiewGroup2->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit13);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =207;
	ui.chBoRls6UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
...
//81 период обзора, мс
	iAddr=iAddrRls1Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls1Prdms->hasFocus())
		ui.liEdRls1Prdms->setText(str);
//81 блокировка, метры
	iAddr=iAddrRls2Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls2Prdms->hasFocus())
		ui.liEdRls2Prdms->setText(str);
//81 блокировка, метры
	iAddr=iAddrRls3Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls3Prdms->hasFocus())
		ui.liEdRls3Prdms->setText(str);
//81 блокировка, метры
	iAddr=iAddrRls4Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls4Prdms->hasFocus())
		ui.liEdRls4Prdms->setText(str);
//81 блокировка, метры
	iAddr=iAddrRls5Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls5Prdms->hasFocus())
		ui.liEdRls5Prdms->setText(str);
//81 блокировка, метры
	iAddr=iAddrRls6Base+17;						//81;
	a1 = unitReceive->basicSetting[iAddr];
	str = QString("%1").arg(a1);
	if(!ui.liEdRls6Prdms->hasFocus())
		ui.liEdRls6Prdms->setText(str);
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2 
	iAddr=iAddrRls1Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls1DistanceAxisVPP_2->hasFocus())
		ui.liEdRls1DistanceAxisVPP_2->setText(str);
//end Rls1::::::::::::::РЛС1
//Rls2::::::::::::::РЛС2
//64...65 параметры источника
//		бит 15:	1 — порт разрешен
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2 
	iAddr=iAddrRls2Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls2DistanceAxisVPP_2->hasFocus())
		ui.liEdRls2DistanceAxisVPP_2->setText(str);
//end Rls2::::::::::::::РЛС2
//Rls3::::::::::::::РЛС3
//64...65 параметры источника
//		бит 15:	1 — порт разрешен
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2 
	iAddr=iAddrRls3Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls3DistanceAxisVPP_2->hasFocus())
		ui.liEdRls3DistanceAxisVPP_2->setText(str);
//end Rls3::::::::::::::РЛС3
//Rls4::::::::::::::РЛС4
//64...65 параметры источника
//		бит 15:	1 — порт разрешен
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2 
	iAddr=iAddrRls4Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls4DistanceAxisVPP_2->hasFocus())
		ui.liEdRls4DistanceAxisVPP_2->setText(str);
//end Rls4::::::::::::::РЛС4
//Rls5::::::::::::::РЛС5
//64...65 параметры источника
//		бит 15:	1 — порт разрешен
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2 
	iAddr=iAddrRls5Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls5DistanceAxisVPP_2->hasFocus())
		ui.liEdRls5DistanceAxisVPP_2->setText(str);
//end Rls5::::::::::::::РЛС5
//Rls6::::::::::::::РЛС6
//64...65 параметры источника
//		бит 15:	1 — порт разрешен
...
//86 удаление антенны от продольной оси ВПП (число знаковое), м, направление 2
	iAddr=iAddrRls6Base+22;						//86;
	str = QString("%1").arg((short)unitReceive->basicSetting[iAddr]);
	if(!ui.liEdRls6DistanceAxisVPP_2->hasFocus())
		ui.liEdRls6DistanceAxisVPP_2->setText(str);
//end Rls6::::::::::::::РЛС6
