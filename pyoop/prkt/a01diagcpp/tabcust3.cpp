...
//-Arp
	connect(ui.coBoArp1ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoArp1ModProt(int)));
	connect(ui.coBoArp1DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoArp1DopId(int)));
	connect(ui.chBoArp1UseDopId,SIGNAL(clicked()),this,SLOT(slChBoArp1UseDopId()));
	connect(ui.coBoArp2ModProt,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoArp2ModProt(int)));
	connect(ui.coBoArp2DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoArp2DopId(int)));
	connect(ui.chBoArp2UseDopId,SIGNAL(clicked()),this,SLOT(slChBoArp2UseDopId()));
...
//-Sev
	connect(ui.coBoSev1DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoSev1DopId(int)));
	connect(ui.chBoSev1UseDopId,SIGNAL(clicked()),this,SLOT(slChBoSev1UseDopId()));
	connect(ui.coBoSev2DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoSev2DopId(int)));
	connect(ui.chBoSev2UseDopId,SIGNAL(clicked()),this,SLOT(slChBoSev2UseDopId()));
//-Met
	connect(ui.coBoMet1DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoMet1DopId(int)));
	connect(ui.chBoMet1UseDopId,SIGNAL(clicked()),this,SLOT(slChBoMet1UseDopId()));
	connect(ui.coBoMet2DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoMet2DopId(int)));
	connect(ui.chBoMet2UseDopId,SIGNAL(clicked()),this,SLOT(slChBoMet2UseDopId()));
//-Met3
	connect(ui.coBoMet3DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoMet3DopId(int)));
	connect(ui.chBoMet3UseDopId,SIGNAL(clicked()),this,SLOT(slChBoMet3UseDopId()));
	connect(ui.coBoMet4DopId,SIGNAL(currentIndexChanged(int)),this,SLOT(slCoBoMet4DopId(int)));
	connect(ui.chBoMet4UseDopId,SIGNAL(clicked()),this,SLOT(slChBoMet4UseDopId()));
...
//-Arp1
void TabCust::slCoBoArp1ModProt(int index)
{
	if(ui.coBoArp1ModProt->hasFocus()&&index<16)
	{
		int iAddr =232;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoArp1DopId(int index)
{
	if(ui.coBoArp1DopId->hasFocus()&&index<16)
	{
		int iAddr =235;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoArp1UseDopId()
{
	int iAddr =235;
	bool b;
	b=ui.chBoArp1UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Arp2
void TabCust::slCoBoArp2ModProt(int index)
{
	if(ui.coBoArp2ModProt->hasFocus()&&index<16)
	{
		int iAddr =312;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slCoBoArp2DopId(int index)
{
	if(ui.coBoArp2DopId->hasFocus()&&index<16)
	{
		int iAddr =315;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoArp2UseDopId()
{
	int iAddr =315;
	bool b;
	b=ui.chBoArp2UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Sev1
void TabCust::slCoBoSev1DopId(int index)
{
	if(ui.coBoSev1DopId->hasFocus()&&index<16)
	{
		int iAddr =395;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoSev1UseDopId()
{
	int iAddr =395;
	bool b;
	b=ui.chBoSev1UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Sev2
void TabCust::slCoBoSev2DopId(int index)
{
	if(ui.coBoSev2DopId->hasFocus()&&index<16)
	{
		int iAddr =411;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoSev2UseDopId()
{
	int iAddr =411;
	bool b;
	b=ui.chBoSev2UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Met1
void TabCust::slCoBoMet1DopId(int index)
{
	if(ui.coBoMet1DopId->hasFocus()&&index<16)
	{
		int iAddr =443;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoMet1UseDopId()
{
	int iAddr =443;
	bool b;
	b=ui.chBoMet1UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Met2
void TabCust::slCoBoMet2DopId(int index)
{
	if(ui.coBoMet2DopId->hasFocus()&&index<16)
	{
		int iAddr =461;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoMet2UseDopId()
{
	int iAddr =461;
	bool b;
	b=ui.chBoMet2UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//---------------------
//-Met3
void TabCust::slCoBoMet3DopId(int index)
{
	if(ui.coBoMet3DopId->hasFocus()&&index<16)
	{
		int iAddr =479;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoMet3UseDopId()
{
	int iAddr =479;
	bool b;
	b=ui.chBoMet3UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//-Met4
void TabCust::slCoBoMet4DopId(int index)
{
	if(ui.coBoMet4DopId->hasFocus()&&index<16)
	{
		int iAddr =497;
		wrd.f(unitReceive->basicSetting[iAddr]);
		wrdWr.f(index);
...
void TabCust::slChBoMet4UseDopId()
{
	int iAddr =497;
	bool b;
	b=ui.chBoMet4UseDopId->isChecked();
	wrd.f(
		unitReceive->basicSetting[iAddr]
		)->bit9=b;
	unitReceive->basicSetting[iAddr]=wrd.f();
...
//биты 14…12 номер модификации протокола
	...
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit14*4+wrd.s.bit13*2+wrd.s.bit12;
	ui.coBoArp2ModProt->setCurrentIndex(a1);
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =315;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoArp2DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =315;
	ui.chBoArp2UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
...
//биты 21…20(5,4): дополнительный идентификатор
	...
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoSev1DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =395;
	ui.chBoSev1UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Sev2
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =411;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoSev2DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =411;
	ui.chBoSev2UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Met1
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =443;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoMet1DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =443;
	ui.chBoMet1UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Met2
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =461;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoMet2DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =461;
	ui.chBoMet2UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Met3
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =479;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoMet3DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =479;
	ui.chBoMet3UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
//-Met4
//биты 21…20(5,4): дополнительный идентификатор
	iAddr0 =497;
	wrd.f(unitReceive->basicSetting[iAddr0]);
	a1 = wrd.s.bit5*2+wrd.s.bit4;
	ui.coBoMet4DopId->setCurrentIndex(a1);
//бит 25(9) использовать дополнительный идентификатор для идентификации
	iAddr0 =497;
	ui.chBoMet4UseDopId->setChecked(
		wrd.f(unitReceive->basicSetting[iAddr0])->bit9);
