...
class Labeltext(Text):
    def __init__(self, panel, row_num, col_num, lab_text="", txt_width =20, txt_height=6, txt_value="",col_span=1,fnc_dbl=0):
        self.panel=ttk.Frame(panel)
        ...
        self.scbr.config(command=self.yview)
        self.config(yscrollcommand=self.scbr.set, wrap = 'word')
